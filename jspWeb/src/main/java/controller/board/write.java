...
public class write extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//1. 저장 경로 [프로젝트 저장]
		// String uploadpath = "C:\\Users\\504\\git\\jspWeb\\jspWeb\\src\\main\\webapp\\upload";	// 최상위 경로
		String uploadpath = request.getSession().getServletContext().getRealPath("/upload");		// getRealPath("업로드할 폴더명")
